        ...
        implements ForecastAdapterOnClickHandler, LoaderManager.LoaderCallbacks<String[]>
{
    ...
    private static final String WEATHER_QUERY_LOC_EXTRA = "location";
    private static final int WEATHER_QUERY_LOADER = 13;
    ...
    private void loadWeatherData() {
        ...
        queryBundle.putString(WEATHER_QUERY_LOC_EXTRA, location);

        LoaderManager loaderManager = getSupportLoaderManager();
        Loader<String> weatherQueryLoader = loaderManager.getLoader(WEATHER_QUERY_LOADER);
        if (weatherQueryLoader == null) {
    ...
    public Loader<String[]> onCreateLoader(int id, final Bundle args) {
        return new AsyncTaskLoader<String[]>(this) {
            ...
            protected void onStartLoading() {
                ...
                if (mWeatherJsonCache != null) {
                    Log.d(TAG, "Fetching data from cache.");
                    deliverResult(mWeatherJsonCache);
                } else {
                    Log.d(TAG, "Fetching data from net.");
                    forceLoad();
                }
            }
            ...
            public String[] loadInBackground() {
                String weatherQueryLocString = args.getString(WEATHER_QUERY_LOC_EXTRA);

                /* If the user didn't enter anything, there's nothing to search for */
                if (weatherQueryLocString == null || TextUtils.isEmpty(weatherQueryLocString)) {
                    return null;
                }

                URL weatherRequestUrl = NetworkUtils.buildUrl(weatherQueryLocString);
            ...
            public void deliverResult(String[] data) {
                mWeatherJsonCache = data.clone();
                Log.d(TAG, mWeatherJsonCache[0]);
